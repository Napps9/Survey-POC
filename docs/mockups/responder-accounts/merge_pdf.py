...
heights — see the header of make_pdf.mjs.
    ...
    python3 merge_pdf.py            # -> responder-accounts-mockups.pdf
"""
import pathlib
import sys
...
OUT = HERE / "responder-accounts-mockups.pdf"

FOOT_LEFT = "Playverto \u00b7 The Vertos you played \u2014 respondent account mockups"
