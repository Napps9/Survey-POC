          ...
          items: {
            ...
            properties: {
              ...
              pages: {
                ...
                description: "SCENARIO ONLY. The user's narrative situation split into 1-5 pages, each a short paragraph (<= 400 chars), in reading order. Preserve the source wording — do not invent story content."
              },
              options: {
                type: "array",
