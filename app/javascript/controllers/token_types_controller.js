...
export default class extends Controller {
  ...
  addRow(event) {
    ...
    row.innerHTML = `
      <input type="text" aria-label="${t("editor.token_types.icon_label").replace(/"/g, "&quot;")}" data-token-types-target="icon" maxlength="8" value="⭐"
      ...
      <input type="text" aria-label="${t("editor.token_types.name_label").replace(/"/g, "&quot;")}" data-token-types-target="name" maxlength="40" placeholder="${t("editor.token_types.name_placeholder").replace(/"/g, "&quot;")}"
