namespace :demo do
  desc "Seed (or reset) the VertoNow demo account: an org, a partner org, a Collective " \
       "Impact partnership, four fully-featured Vertos, and simulated respondents. " \
  ...
  desc "Remove the VertoNow demo account and everything under it (Vertos, responses, partnership)."
